...
class UpdateProductRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'remove_video_ids.*' => ['integer', 'exists:product_videos,id'],
        ];
    }
    ...
    public function messages(): array
    {
        return [
            ...
            'remove_image_ids.*.exists' => 'الصورة المحددة للحذف غير موجودة.',
            'remove_video_ids.*.exists' => 'رابط الفيديو المحدد للحذف غير موجود.',
        ];
    }
    ...
    public function attributes(): array
    {
        return [
            ...
            'remove_image_ids' => 'الصور المراد حذفها',
            'remove_video_ids' => 'روابط الفيديو المراد حذفها',
        ];
    }
